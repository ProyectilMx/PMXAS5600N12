...
const PinDescription g_APinDescription[]=
{
 ...
 // { PORTA,  8, PIO_SERCOM_ALT, (PIN_ATTR_DIGITAL|PIN_ATTR_PWM|PIN_ATTR_TIMER), ADC_Channel16, PWM0_CH0, TCC0_CH0, EXTERNAL_INT_NMI },  // TCC0/WO[0]
  { PORTA,  16, PIO_SERCOM, (PIN_ATTR_DIGITAL|PIN_ATTR_PWM|PIN_ATTR_TIMER), ADC_Channel16, PWM0_CH0, TCC0_CH0, EXTERNAL_INT_NMI },  // TCC0/WO[0]
  ...
  { PORTA,  17, PIO_SERCOM, (PIN_ATTR_DIGITAL|PIN_ATTR_PWM|PIN_ATTR_TIMER), ADC_Channel17, PWM0_CH1, TCC0_CH1, EXTERNAL_INT_9 }, // TCC0/WO[1]
  // D3, ADC, PWM, IRQ, UART RX, Captouch and general purpose pin
  { PORTA,  11, PIO_SERCOM, (PIN_ATTR_DIGITAL|PIN_ATTR_PWM|PIN_ATTR_TIMER), ADC_Channel7, PWM1_CH1, TCC1_CH1, EXTERNAL_INT_7 }, // TCC1/WO[1]

  // D4, ADC, PWM, IRQ, UART TX, Captouch and general purpose pin
  { PORTA,  10, PIO_SERCOM, (PIN_ATTR_DIGITAL|PIN_ATTR_PWM|PIN_ATTR_TIMER), ADC_Channel6, PWM1_CH0, TCC1_CH0, EXTERNAL_INT_6 }, // TCC1/WO[0]
  ...
  // A2
  { PORTA,  3, PIO_ANALOG, (PIN_ATTR_ANALOG|PIN_ATTR_DIGITAL|PIN_ATTR_PWM|PIN_ATTR_TIMER), ADC_Channel16, PWM0_CH0, TCC0_CH0, EXTERNAL_INT_NMI },  // TCC0/WO[0]
  // A3
  ...
  //  #21 & 22 
  { PORTA, 18, PIO_DIGITAL, (PIN_ATTR_DIGITAL), No_ADC_Channel, NOT_ON_PWM, NOT_ON_TIMER, EXTERNAL_INT_14 },
  { PORTA, 19, PIO_DIGITAL, (PIN_ATTR_DIGITAL|PIN_ATTR_PWM|PIN_ATTR_TIMER), No_ADC_Channel, PWM3_CH1, TC3_CH1, EXTERNAL_INT_15 },
  
  // Anexadas para LINAC_V1.0
 
   { PORTA, 2, PIO_DIGITAL },   // 23
   { PORTA, 3, PIO_DIGITAL },	// 24
   { PORTA, 4, PIO_DIGITAL },	// 25
   { PORTA, 5, PIO_DIGITAL },   // 26
   { PORTA, 6, PIO_DIGITAL },	// 27
   { PORTA, 7, PIO_DIGITAL },	// 28
   { PORTA, 9, PIO_DIGITAL },   // 29
   { PORTA, 14, PIO_DIGITAL },	// 30
   { PORTA, 31, PIO_DIGITAL },	// 31
   { PORTA, 23, PIO_DIGITAL },	// 32
   { PORTA, 28, PIO_DIGITAL },	// 33
